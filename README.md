# Super Monedero Built Using Beautiful Jekyll 
...
mailchimp   | By default, a mailchimp embedded subscription form is shown on all posts unless you use `mailchimp: false`. 
