            ...
            <tr>\
              ...
              <td class='right-column' rowspan='3'>\
                <table class='table borderless card-actions'>\
                  ...
                  <tr><td><a href='%%card_apply_now_url%%' target='_blank' class='btn btn-success vertical-buttons' onclick=\"trackOutboundLink('%%card_apply_now_url%%');\">Apply Now</a></td></tr>\
            ...
            <tr>\
              <td>\
                ...
                <div style='width: 100%;' class='text-center no-big'>\
                  <a href='%%card_apply_now_url%%' target='_blank' class='btn btn-success' onclick=\"trackOutboundLink('%%card_apply_now_url%%');\">Apply Now</a>\
